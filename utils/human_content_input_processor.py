...
class HumanContentInputProcessor:
    """
    ...
    def get_image_content_dict_from_base64(
        ...
        Args:
            ...
            image_type: (Literal), 图片的类型。需要VLM支持，默认为png。
    ...
    def get_image_content_dict_from_uri(
        ...
        Args:
            ...
            image_type: 图片的类型。需要VLM支持，默认为png。
        ...
        return HumanContentInputProcessor.get_image_content_dict_from_base64(
