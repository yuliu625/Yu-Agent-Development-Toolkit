...
## 🚀 仓库现状
> 为了实现更极致的工程解耦，我对 Agent 系统进行了“逻辑与底座分离”的优化。本仓库的定位已演进为纯粹的 Agent 决策与流程控制工具集，不再包含底层推理和基础检索的实现。

- **底层推理与部署**: 关于 LLM 推理优化、模型服务化及 API 统一封装的内容，请移步 [AI-Inference-Stack](https://github.com/yuliu625/Yu-AI-Inference-Stack) 。
- **知识检索与 RAG**: 关于向量数据库、文档切割及检索增强的具体实现，请移步 [RAG-Toolkit](https://github.com/yuliu625/Yu-RAG-Toolkit)。
...
### OpenAI Forge
针对原生 OpenAI SDK 的轻量化封装，适用于不需要复杂框架的极简场景。
...
### 通用工具集
- **[AI-Inference-Stack](https://github.com/yuliu625/Yu-AI-Inference-Stack)**: 推理服务化工具。
