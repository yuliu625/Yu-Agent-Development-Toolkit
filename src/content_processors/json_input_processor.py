"""
Sources:
    https://github.com/yuliu625/Yu-Agent-Development-Toolkit/blob/main/src/content_processors/json_input_processor.py
...
class JsonInputProcessor:
    ...
    # ==== 已弃用。使用 jinja2、PromptTemplate 、一次性完成所有的 format ，不会遇到以下方法的目标情况。 ====
    @staticmethod
    def _escape_braces(
        string: str
    ) -> str:
        ...
        这个方法的目的:
            ...
            - 为了 json 数据避免被转换。
        但是:
            - 在使用 jinja2 ，以及 langchain 的 PromptTemplate 后，这个方法基本不再被使用。
        """
